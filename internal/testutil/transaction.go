...
func newPrivateTransaction(tx *gorm.DB, key repository.KeyRepository, marketplace repository.MarketplaceRepository, adminAudit repository.AdminAuditRepository) repository.PrivateTransaction {
...
func newPublicTransaction(tx *gorm.DB, reversal repository.ReversalRepository) repository.PublicTransaction {
